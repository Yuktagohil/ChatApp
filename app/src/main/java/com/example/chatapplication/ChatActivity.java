...
public class ChatActivity extends AppCompatActivity {
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (uri != null) {
                            ...
                            // Handle error or log message appropriately
                        }
                    } else {
                        Log.e(TAG, "Failed to retrieve download URL: " + task.getException());
                        // Handle failure case
                    }
                });
    ...
    public void FirebaseAccessTokenProvider(Context context) {
    ...
    private String getAccessToken() throws IOException {
        InputStream serviceAccount = getAssets().open("chatapplication-19edd-firebase-adminsdk-gq6jd-55c061364b.json");
    ...
    void callApi(JSONObject jsonObject) throws IOException {
        ...
        String url = "https://fcm.googleapis.com/v1/projects/chatapplication-19edd/messages:send";
